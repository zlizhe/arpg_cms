			...
			<?php if($_Guser): ?><ul class="nav navbar-nav navbar-right userList">
		        	<li class="dropdown">
		          		...
		          		<ul class="dropdown-menu" role="menu">
		          			<li><a onclick="ajaxLink($(this));return false;" href="/space/<?php echo ($_Guser['uid']); ?>">我的主页</a></li>
		            		<li><a onclick="ajaxLink($(this));return false;" href="<?php echo U('/space/setup');?>">账号设置</a></li>
